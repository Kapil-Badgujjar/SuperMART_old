...
export default function SignupPage() {
  ...
  function addUser(event){
    ...
    async function requsetSignup(){
      try {
        const response = await axios.post(`https://super-mart-backend.vercel.app/user/signup`,{email: email, username: newUserName, password: userPassword},{withCredentials: true}); 
