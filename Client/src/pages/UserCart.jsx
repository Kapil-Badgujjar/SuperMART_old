...
export default function UserCart() {
  ...
  useEffect(() =>{
    ...
    async function fun(){
      const response = await axios.get(import.meta.env.VITE_SERVER_ADDRESS+'/cart/getUserCart',{withCredentials: true});
  ...
  const handlePayment = async () => {
    console.log('Payment cliked');
      try{
          const {data} = await axios.post(import.meta.env.VITE_SERVER_ADDRESS+"/payments/create-payment-session",{userID: userID},{withCredentials:true});
          console.log(data);
