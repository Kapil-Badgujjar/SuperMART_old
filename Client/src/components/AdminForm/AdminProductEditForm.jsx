    ...
    const { productDetails, setProductDetails,                 
        ...
        function submitFunction(event){
            ...
            async function fun(){  
                ...
                try {
                    console.log(flag)
                    const {data} = await axios.post(flag ? import.meta.env.VITE_SERVER_ADDRESS+'/products/Update-product' : import.meta.env.VITE_SERVER_ADDRESS+'/products/add-product' ,formData,{
                        headers: {
        ...
        async function deleteFun(ev){
            ev.preventDefault();
            await axios.post(import.meta.env.VITE_SERVER_ADDRESS+'/products/delete-product' ,{productID: productDetails.id}, {withCredentials: true});
            navigate('/admin');
        }
    return (
